  ...
  <div class="layout-wrapper layout-content-navbar ">
    ...
    <ul class="menu-inner py-1 ps ps--active-y">
      ...
      <li class="menu-item active open">
        <a href="http://127.0.0.1:8000" class="menu-link menu-toggle">
      ...
      <li class="menu-item ">
        <a href="https://themeselection.com/demo/sneat-bootstrap-html-admin-template/documentation/laravel-introduction.html" class="menu-link" target="_blank">
            ...
            <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 396px; right: 4px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 106px;"></div></div></ul>
